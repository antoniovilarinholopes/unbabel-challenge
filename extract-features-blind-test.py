...
#def datasets_to_file(dataset, dataset_pos, header, destination):
    ...
    with open(destination, 'w') as f:
        ...
        for idx in range(len(dataset)):
            ...
            f.write('{},{},{},{},{},{},{}\n'.format(dataset[idx], dataset2[idx], dataset_pos[idx], dataset_pos2[idx], sentence_length[idx], num_prep[idx], cls))
...
file_to_write = 'features_blind_test/features_test.csv'
header = 'f_wh,f_wmt,f_posh,f_posmt,length,num_prep, class'
